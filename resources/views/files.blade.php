                ...
                <div>
                    <div class="flex items-center justify-between flex-wrap mb-4">
                        ...
                        <div class="mt-4 sm:mt-0">
                            <button class="bg-gray-200 h-12 px-6 mr-2 mb-2 sm:mb-0">
                                Neuer Ordner
                            </button>
...
{{--            <div class="bg-white overflow-hidden shadow-md p-6 mt-3">--}}
{{--                <div class="flex items-center justify-between flex-wrap bg-gray-100 h-12 px-3">--}}
{{--                    <div>Name</div>--}}
{{--                    <div>Grösse</div>--}}
{{--                    <div>Datum</div>--}}
{{--                    <div>Aktionen</div>--}}
            ...
            <div class="bg-white overflow-hidden shadow-md p-6 mt-1 hover:bg-blue-300">
                <div class="flex items-center justify-between flex-wrap px-3">
                       <div class="flex items-center p-3">
                           ...
                           <a href="" class="font-bold text-lg text-blue-600">DateinameDateinameDateinameDateiname</a>
                       </div>
                       <div class="p-3">&mdash;</div>
                       <div class="p-3">Datum</div>
                       <div class="p-3">
                           <div class="">
